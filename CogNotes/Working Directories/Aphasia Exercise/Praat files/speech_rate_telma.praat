...
form Counting Syllables in Sound Utterances
   ...
   sentence directory C:/Users/esben/Desktop/Study/Cognition & Communication/Class 10 - ML/Aphasia_thompson
endform
...
printline soundname, nsyll, npause, dur(s), phonationtime(s), speechrate(nsyll/dur), articulation_rate(nsyll/phonationtime), ASD(speakingtime/nsyll)
...
# use object ID
  ...
  # get pauses (silences) and speakingtime
   ...
   # in order to allow nonzero s tarting times.
...
# summarize results in Info window
   ...
   #select TextGrid untitled
	...
	Save as text file... 'soundname$'.TextGrid
	Remove
